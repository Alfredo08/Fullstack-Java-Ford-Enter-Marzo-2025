...
public class ServicioDirectores {
	...
	public Director agregarDirector(Director director) {
		// Encriptar la contraseña del director
		String contraseniaEncriptada = BCrypt.hashpw(director.getContrasenia(), BCrypt.gensalt());
		director.setContrasenia(contraseniaEncriptada);
