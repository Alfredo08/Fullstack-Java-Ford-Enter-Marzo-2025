...
public class Director {
	...
	@Size(min=3, message="El nombre del director debe de contener al menos 3 letras.")
	private String nombre;
	
	@NotBlank(message = "Por favor proporciona los apellidos del director.")
	@Size(min=3, message="Los apellidos del director deben de contener al menos 3 letras.")
